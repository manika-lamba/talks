...
7. Seeding (so that one can reproduce the algorithm with the same selected
parameters)
8. Running the selected algorithm using proprietary or open-source tools (such
as RapidMiner, TopicModelingTool) or programming languages (such as R or
Python)
...
- [textmineR](https://cran.r-project.org/package=textmineR)
.....(more!)
:::
...
- [dynamic_topic_modeling](https://pypi.org/project/dynamic-topic-modeling/)
.....(more!)
:::
:::
...
- “Topic models are meant to help interpret and understand texts, but it is still the researcher’s job to
do the actual interpreting and understanding” (Blei, 2012)
...
# Topics Evolve {background-color="#F7D9C4"}
...
# Application {background-color="#F7D9C4"}
