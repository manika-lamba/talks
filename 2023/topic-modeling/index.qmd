...
# [![](img/slide1.png){fig-align="center"}](https://textmining-infopros.github.io/project/topic-modeling/){background-color="#F7D9C4"}
...
- While partial validation of the statistical model
is possible, a **conceptual validation** would require an extended triangulation with other methods and
human ratings, and clarification of whether statistical distinctivity of lexical co-occurrence correlates
with conceputal topics in any reliable way
